...
- (void)changeNavigationOriginal {
    [self.navigationController.navigationBar setBackgroundImage:[UIColor imageWithColor:COLOR_Main] forBarMetrics:UIBarMetricsDefault];
...
- (void)initRightBarView
{
    ...
    [btn_right setTitleTextAttributes:@{NSForegroundColorAttributeName:[UIColor colorWithHexString:COLOR_BLUE_MAIN]} forState:UIControlStateNormal];
    self.navigationController.interactivePopGestureRecognizer.delegate = self;
